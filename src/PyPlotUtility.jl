module PyPlotUtility
    ...
    export  axis_ticks_styling!, cb_ticks_styling!, plot_styling!,
            ...
            get_streamlines,
            bin_1D, bin_1D!, bin_1D_log, bin_1D_log!, 
            bin_1D_quantity, bin_1D_quantity!, 
            bin_1D_quantity_log, bin_1D_quantity_log!, 
            bin_2D, bin_2D!, bin_2D_log, bin_2D_log!, 
            bin_2D_quantity!, bin_2D_quantity_log!,
